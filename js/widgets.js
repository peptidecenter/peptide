...
(function () {
  ...
  function initContactWidget() {
    var waPhone = '972500000000';
    var waText = encodeURIComponent('שלום, הגעתי דרך האתר Peptide Center ואני מעוניין לקבל ייעוץ על פפטידים.');
    var tgUser = 'YourTelegramUsername';
